        ...
        <div class="panel-body">
            ...
            <div id="updatedialog" style="font: 70% 'Trebuchet MS', sans-serif; margin: 50px; display: none;"
                ...
                <table cellpadding="0" class="style1">
                    ...
                    <tr>
                        <td class="alignRight">Paciente:</td>
                        <td class="alignLeft">
                            <input id="eventPaciente" type="text" size="50" /><br />
                        </td>
                        <td class="alignRight">
                            <button role='button' class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" style="margin-left: 10px" type="button">Buscar</button>
                        </td>
                    </tr>
                    <tr style="display: none">
                    ...
                    <tr>
                        ...
                        <td class="alignLeft">
                            <input id="eventNombre" type="text" size="50" /><br />
                        </td>
                    </tr>
                    <tr>
                        <td class="alignRight">Apellido:</td>
                        <td class="alignLeft">
                            <input id="eventApellido" type="text" size="50" /><br />
                        </td>
                    </tr>
                    <tr>
                        <td class="alignRight">Teléfono:</td>
                        <td class="alignLeft">
                            <input id="eventTel" type="text" size="50" /><br />
                        </td>
                    </tr>
                    <tr>
            ...
            <div runat="server" id="addDialog" style="font: 70% 'Trebuchet MS', sans-serif; margin: 50px;" title="Agregar turno">
                ...
                <table cellpadding="0" class="style1" runat="server">
                    ...
                    <tr>
                        <td class="alignRight">Paciente:</td>
                        <td class="alignLeft">
                            <input id="txtDoc" runat="server" type="text" class="form-control" placeholder="Ingrese documento..." />
                        </td>
                        <td class="alignRight">
